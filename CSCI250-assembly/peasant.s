	#schirduan_peasant.s
	#
	#a MIPS program that uses the peasant method to multiply
	#two numbers together, while adjusting for overflow 
	#possbilities.
	#
	#$t0 is num1
	#$t1 is num2
	...
	.data
	str:		.asciiz "enter the two numbers to be multiplied\n"
